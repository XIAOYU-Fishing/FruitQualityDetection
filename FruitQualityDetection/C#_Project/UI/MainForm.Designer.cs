namespace FruitQualityDetection.UI
{
    partial class MainForm
    {
        ...
        private System.Windows.Forms.Button btnImportVideo, btnPlayPause, btnStopVideo;
        private System.Windows.Forms.CheckBox chkRealtimeDetect;
        ...
        private void InitializeComponent()
        {
            ...
            this.chkRealtimeDetect = new System.Windows.Forms.CheckBox();
            ...
            System.Windows.Forms.Button[] buttons = {
                btnImportImage, btnImportVideo, btnLoadModel, btnDetect,
                btnExport, btnCalibrate, btnPlayPause, btnStopVideo
            };
            string[] texts = {
                "📷 导入图片", "🎬 导入视频", "📦 加载模型", "🔍 开始检测",
                "💾 导出结果", "📐 开始标定", "▶ 播放", "⏹ 停止"
            ...
            for (int i = 0; i < buttons.Length; i++)
            {
                ...
                buttons[i].Width = 180; buttons[i].Height = 35;
                ...
                buttons[i].Font = new System.Drawing.Font("微软雅黑", 9F);
                this.panelLeft.Controls.Add(buttons[i]);
                y += 42;
            }

            this.chkRealtimeDetect.Text = "☑ 实时检测";
            this.chkRealtimeDetect.ForeColor = System.Drawing.Color.White;
            this.chkRealtimeDetect.Top = y; this.chkRealtimeDetect.Left = 10;
            this.chkRealtimeDetect.Width = 180; this.chkRealtimeDetect.Height = 25;
            this.chkRealtimeDetect.Checked = false;
            this.chkRealtimeDetect.Font = new System.Drawing.Font("微软雅黑", 10F);
            this.panelLeft.Controls.Add(this.chkRealtimeDetect);
            y += 35;

            this.lblEraserLength.Text = "橡皮长(mm):";
            this.lblEraserLength.ForeColor = System.Drawing.Color.White;
            this.lblEraserLength.Top = y; this.lblEraserLength.Left = 10;
            this.lblEraserLength.Width = 80; this.lblEraserLength.Height = 20;
            this.txtEraserLength.Text = "40";
            this.txtEraserLength.Top = y; this.txtEraserLength.Left = 95;
            this.txtEraserLength.Width = 90; this.txtEraserLength.Height = 20;
            y += 30;

            this.lblEraserWidth.Text = "橡皮宽(mm):";
            this.lblEraserWidth.ForeColor = System.Drawing.Color.White;
            this.lblEraserWidth.Top = y; this.lblEraserWidth.Left = 10;
            this.lblEraserWidth.Width = 80; this.lblEraserWidth.Height = 20;
            this.txtEraserWidth.Text = "20";
            this.txtEraserWidth.Top = y; this.txtEraserWidth.Left = 95;
            this.txtEraserWidth.Width = 90; this.txtEraserWidth.Height = 20;
            y += 35;

            this.lblScale.Text = "比例尺: 未标定";
            this.lblScale.ForeColor = System.Drawing.Color.Yellow;
            this.lblScale.Top = y; this.lblScale.Left = 10;
            this.lblScale.Width = 180; this.lblScale.Height = 20;
            ...
            this.Text = "水果质量检测系统 v2.0 | Halcon 25.11 + YOLO11 + 视频检测";
            ...
            this.chkRealtimeDetect.CheckedChanged += new System.EventHandler(this.chkRealtimeDetect_CheckedChanged);
